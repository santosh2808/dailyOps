...
export default function DeleteLeadConfirmDialog({
  open,
  onOpenChange,
  lead,
  onConfirm,
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      const message = getErrorMessage(err, "Could not delete this lead. Please try again.");
      setError(message);
      toast.error(message);
    } finally {
      setSubmitting(false);
      ...
      <DialogContent onClose={() => onOpenChange(false)} size="sm">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {lead.companyName}? It will be removed from the pipeline. The record itself
