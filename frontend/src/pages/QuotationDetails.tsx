...
import { ArrowLeft, ArrowRightCircle, Pencil, RefreshCw, Trash2 } from "lucide-react";
            ...
            <div className="mx-auto max-w-4xl space-y-6">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {quotation.customer?.companyName ?? "Unknown customer"}
                  </p>
                </div>
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                  ...
                  <Field label="Customer" value={quotation.customer?.companyName} />
                  <Field label="Contact Person" value={quotation.customer?.contactPerson} />
